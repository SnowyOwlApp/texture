...
export default {
  ...
  configure (config) {
    ...
    registerCollectionCommand(config, 'author', ['metadata', 'authors'], { keyboardShortcut: 'CommandOrControl+Alt+A' })
    registerCollectionCommand(config, 'award', ['metadata', 'awards'], { keyboardShortcut: 'CommandOrControl+Alt+Y' })
    registerCollectionCommand(config, 'editor', ['metadata', 'editors'], { keyboardShortcut: 'CommandOrControl+Alt+E' })
    registerCollectionCommand(config, 'footnote', ['article', 'footnotes'], { automaticOrder: true })
...
function registerCollectionCommand (config, itemType, collectionPath, options = {}) {
  ...
  config.addCommand(`add-${itemType}`, AddEntityCommand, {
    type: itemType,
